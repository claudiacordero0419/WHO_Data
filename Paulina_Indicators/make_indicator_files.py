...
INDICATOR_CODES = [
    ...
    "HEPATITIS_HBV_LIVINGWITH_NUM",
    "HEPATITIS_HCV_LIVINGWITH_NUM",
    "HEPATITIS_HBV_DEATHS_NUM",
    "HEPATITIS_HCV_DEATHS_NUM",
    "HEPATITIS_DEATHS_RATE",
    "HEPATITIS_HBV_PREVALENCE_PER100",
    "HEPATITIS_HCV_PREVALENCE_PER100",
    "HEPATITIS_HCV_TREATMENT_INITIATED_NUM",
    "SDGHEPHBSAGPRV",
    "ASSISTIVETECH_Q06",
    "ASSISTIVETECH_Q03",
    "ASSISTIVETECH_Q05",
    "ASSISTIVETECH_Q01",
    "ASSISTIVETECH_TOTALNEED",
    "ASSISTIVETECH_METNEED",
    "ASSISTIVETECH_USEPREVALENCE",
]
